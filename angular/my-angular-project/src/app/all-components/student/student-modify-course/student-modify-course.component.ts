...
@Component({
  selector: 'app-student-modify-course',
  templateUrl: './student-modify-course.component.html',
  styleUrls: ['./student-modify-course.component.css']
})
export class StudentModifyCourseComponent implements OnInit {
...
// Déclarez un formulaire réactif pour gérer les entrées de l'utilisateur
  ...
  this.newnotification.Content = 'you modified your cour with : ' + this.courseFormData.TeacherName ;
  ...
  Cancel() {
    ...
    if (studentData) {
      ...
      this.router.navigate(['/student-futur-courses', this.student.Idstudent]);
    }
  }
